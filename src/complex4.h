...
Program developed by Alejandro Algora: Alejandro.Algora@ific.uv.es
...
std::complex<double> cgamma(const std::complex<double> x){
  
  std::complex<double> y;
  G4double xr, xi, wr, wi, ur, ui, vr, vi, yr, yi, t;
